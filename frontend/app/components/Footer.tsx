    ...
    <footer className="bg-blue-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          {/* Column 1: MEDDICAL Brand */}
          <div className="space-y-4">
            <h2 className="text-3xl lg:text-4xl text-blue-100" style={{ fontFamily: 'var(--font-yeseva-one)' }}>
              MEDDICAL
            </h2>
            <p className="text-white text-base leading-relaxed" style={{ fontFamily: 'var(--font-work-sans)' }}>
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-white text-lg" style={{ fontFamily: 'var(--font-work-sans)' }}>
              Important Links
            </h3>
            <div className="space-y-2">
              <button
                onClick={() => handleSectionNavigation('doctors')}
                className="block text-white hover:text-blue-200 transition-colors text-left"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <p className="text-white" style={{ fontFamily: 'var(--font-work-sans)' }}>
            ...
            <form onSubmit={handleNewsletterSubmit} className="space-y-3">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2 bg-blue-100 text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-300 pr-12"
                  style={{ fontFamily: 'var(--font-work-sans)' }}
                  required
                />
                <button
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="text-center md:text-left">
            <p className="text-white text-sm" style={{ fontFamily: 'var(--font-work-sans)' }}>
              &copy; 2025 Medical Center All Rights Reserved by PNTEC-LTD
            </p>
          </div>
