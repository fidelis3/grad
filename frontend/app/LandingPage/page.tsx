...
const HeartIcon = ({ className }: { className: string }) => (
  <svg className={className} width="50" height="44" viewBox="0 0 50 44" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<svg className={className} width="32" height="39" viewBox="0 0 32 39" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const EmailIcon = ({ className }: { className: string }) => (
 <svg className={className} width="39" height="32" viewBox="0 0 39 32" fill="none" xmlns="http://www.w3.org/2000/svg">
