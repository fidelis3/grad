...
const MapPinIcon = ({ className }: { className?: string }) => (
  <svg className={className} width="33" height="39" viewBox="0 0 33 39" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default function HealthRecordsPage() {
  ...
  const handleInputChange = (field: keyof HealthRecord, value: string) => {
    ...
    document.documentElement.style.setProperty('--blood-pressure-progress', `${fieldProgress.bloodPressure}%`);
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
              <div className="flex items-center justify-center lg:justify-start">
                <h1 className="text-2xl lg:text-3xl font-yeseva-one">
              ...
              <div className="hidden lg:flex lg:items-center lg:space-x-8">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <p className="font-medium text-base text-blue-900 font-work-sans">
                      EMERGENCY
                    </p>
                    <p className="font-medium text-base text-blue-500 font-work-sans">
                      (237) 681-812-255
                    </p>
                  </div>
                </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <label className="text-black font-medium mb-2 flex items-center">
                  ...
                  <div className="ml-2 w-16 bg-gray-200 rounded-full h-1">
                    <div 
                      ...
                      data-progress={`${fieldProgress.allergies}%`}
                    ></div>
                  </div>
                </label>
                <textarea
              ...
              <div className={`relative transition-all duration-200 ${focusedField === 'medications' ? 'transform scale-105' : ''}`}>
                <label className="text-black font-medium mb-2 flex items-center">
                  ...
                  <div className="ml-2 w-16 bg-gray-200 rounded-full h-1">
                    <div 
                      className={`bg-green-500 h-1 rounded-full transition-all duration-300 progress-bar`}
                      data-progress={`${fieldProgress.medications}%`}
                    ></div>
                  </div>
                </label>
                <textarea
              ...
              <div className={`relative transition-all duration-200 ${focusedField === 'medicalHistory' ? 'transform scale-105' : ''}`}>
                <label className="text-black font-medium mb-2 flex items-center">
                  ...
                  <div className="ml-2 w-16 bg-gray-200 rounded-full h-1">
                    <div 
                      className={`bg-green-500 h-1 rounded-full transition-all duration-300 progress-bar-medical-history`}
                      data-progress={`${fieldProgress.medicalHistory}%`}
                    ></div>
                  </div>
                </label>
                <textarea
              ...
              <div className={`transition-all duration-200 ${focusedField === 'bloodPressure' ? 'transform scale-105' : ''}`}>
                <label className="text-black font-medium mb-2 flex items-center">
                  ...
                  <div className="ml-2 w-16 bg-gray-200 rounded-full h-1">
                    <div 
                      className={`bg-green-500 h-1 rounded-full transition-all duration-300 progress-bar-blood-pressure`}
                    ></div>
                  </div>
                </label>
